  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Enhanced Info Box with Background */}
        <div className="relative bg-gradient-to-br from-indigo-600 via-blue-600 to-purple-700 rounded-2xl shadow-2xl overflow-hidden mb-8">
          {/* Decorative Elements */}
          ...
          <div className="relative z-10 p-8 md:p-10">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {/* MCQ Tests */}
              <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 hover:bg-white/20 transition-all duration-300 border border-white/20">
                <div className="flex items-start space-x-3">
                  <div className="bg-green-400 rounded-full p-1 mt-1 flex-shrink-0">
                    <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
                    </svg>
                  </div>
                  <div>
                    <p className="text-white font-semibold text-lg">MCQ Tests</p>
                    <p className="text-blue-100 text-sm">AI-generated questions tailored to your topics</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 hover:bg-white/20 transition-all duration-300 border border-white/20">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-white font-semibold text-lg">Real-time Feedback</p>
                    <p className="text-blue-100 text-sm">Instant AI-powered performance analysis</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 hover:bg-white/20 transition-all duration-300 border border-white/20">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-white font-semibold text-lg">LAT Essay Grading</p>
                    <p className="text-blue-100 text-sm">Professional essay evaluation with structured feedback</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 hover:bg-white/20 transition-all duration-300 border border-white/20">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-white font-semibold text-lg">AI Counseling</p>
                    <p className="text-blue-100 text-sm">Get personalized study plans based on your performance</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 hover:bg-white/20 transition-all duration-300 border border-white/20">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-white font-semibold text-lg">WhatsApp Alerts</p>
                    <p className="text-blue-100 text-sm">Daily quiz questions and test notifications via WhatsApp</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 hover:bg-white/20 transition-all duration-300 border border-white/20">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-white font-semibold text-lg">Analytics Dashboard</p>
                    <p className="text-blue-100 text-sm">Track progress with visual charts and insights</p>
                  </div>
                </div>
              </div>
            </div>
